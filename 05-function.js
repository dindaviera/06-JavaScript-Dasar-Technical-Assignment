...
function taxCalc(salary){
    ...
    if(salary < 5000000){
      const pajak=salary * 0/100;
      return pajak;
    }else if(salary <= 5000000  ||  salary <10000000 ){
      const pajak=salary* 5/100;
      return pajak;
    }else if(salary <= 10000000 || salary <20000000 ){
      const pajak=salary * 10/100;
      return pajak;
    }else if(salary <= 20000000 ){
      const pajak=salary * 20/100;
      return pajak;
    }
  }
...
function checkBMI(weight,height){
  ...
  console.log(checkBMI(20,150));
  console.log(checkBMI(50,150));
  console.log(checkBMI(60,150));
  console.log(checkBMI(70,150));
  console.log(checkBMI(100,150));
...
console.log(convToUpperCase("bandung"))
